...
To look at all python you have
```{r}
reticulate::py_config()
```

Test which is your default python by typing:
```{r}
Sys.which("python")
```

Try to install the dependencies into this default python path or a virtual environment(either system virtual environment or anaconda virtual environment):
...
Please look `reticulate` package documentation to find out how to specify a particular python path(virtual environment).
