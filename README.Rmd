...
To run the examples,  you need to have the Python Packages `numpy`, `tensorflow-1.8.0`, `keras-2.1.6`, `gym-0.10.5` installed in the **same** python path. 

This python path can be your system default python path or a virtual environment(either system virtual environment or anaconda virtual environment).
