...
AgentFactory$static = list(
  "DQN" = function(actCnt, stateCnt, surro_fun, memname, policy_fun, glogger) AgentDQN$new(actionCnt = actCnt, stateCnt = stateCnt, surro_fun = surro_fun, memname = memname, policy_fun, glogger = glogger),
  ...
  "A3C" = function(actCnt, stateCnt, surro_fun, memname, policy_fun, glogger) AgentActorCritic$new(actionCnt = actCnt, stateCnt = stateCnt, surro_fun = surro_fun, memname = memname, policy_fun, glogger = glogger)
  )
