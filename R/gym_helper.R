...
fdqn_cart = function(iter = 1L) {
  conf = rlR::RLConf$new(
           ...
           replay.batchsize = 50L,
           interact.beforeActPipe = c("render", "epi-step-log"),
           agent.nn.arch = list(nhidden = 64, act1 = "linear", act2 = "linear", loss = "mse", lr = 0.00005, kernel_regularizer = "regularizer_l2(l=0.000001)", bias_regularizer = "regularizer_l2(l=0)"))
